...
#define  USB_CFG_VENDOR_ID       0xd0, 0x16 /* = 0x16d0 = mcselec.com */
/* MCS Electronics owns this USB VID and sells inofficial PIDs to 3rd parties */
/* USB.org revoked the VID in the meantime; but the VID/PIDs are still unique */
...
#define  USB_CFG_DEVICE_ID       0x7e, 0x08 /* VID sold to digistump.com */
/* We use this PID (instead of the open obdev.at PID) because it matches */
/* the Digistump CDC driver for Windows */
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'V','U','S','B',' ','S','e','r','i','a','l'
